...
index.ts                          ← Extension entry point (piFreeEntry)
  ...
  ├─ lib/pi-ai-loader.ts          ← Robust runtime loader for pi-ai entry points (bare specifier + on-disk fallback)
